...
var goibibo = function() {
    ...
    var _searchBus = function(searchBusQuery, cb) {
        ...
        var url = config.goibibo.url + 'bus/search/?app_key=' + config.goibibo.app_id + '&app_key=' + config.goibibo.app_key + '&format=json&source=' + from + '&destination=' + to + '&dateofdeparture=' + departDate + '"'
        request({
            url: url,
            json: true
