...
var url = config.goibibo.url + 'bus/search/?app_key=' + config.goibibo.app_id + '&app_key=' + config.goibibo.app_key + '&format=json&source=sivagangai&destination=coimbatore&dateofdeparture=20180215"'
